...
export default function ProblemPage() {
  ...
  return (
    <div className="h-screen bg-[#0B0B1A] text-white relative overflow-hidden flex flex-col">
      {/* Ambient glow, same language as homepage but quieter */}
      ...
      <header className="relative z-10 flex items-center gap-4 px-6 py-4 border-b border-white/10 bg-white/[0.02] backdrop-blur-sm shrink-0">
        ...
        <button className="ml-auto flex items-center gap-2 px-4 py-1.5 rounded-lg bg-violet-500 hover:bg-violet-400 text-white text-sm font-semibold font-mono transition-colors shadow-[0_0_20px_-4px_rgba(124,58,237,0.6)]">
